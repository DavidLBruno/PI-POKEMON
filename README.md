...
- ✔️[ ] Botones/Opciones para ordenar tanto ascendentemente como descendentemente los pokemons por orden alfabético y por ataque
- ✔️[ ] Paginado para ir buscando y mostrando los siguientes pokemons, 12 pokemons por pagina.
...
- ✔️[ ] Estadísticas (vida, ataque, defensa, velocidad)
- ✔️[ ] Altura y peso

**Ruta de creación**: debe contener

- ✔️[ ] Un formulario **controlado con JavaScript** con los campos mencionados en el detalle del Pokemon
